 ...
 */
public final class CompatDiskLruCache implements Closeable, Flushable {
  ...
  private final Runnable cleanupRunnable = new Runnable() {
    public void run() {
      synchronized (CompatDiskLruCache.this) {
  ...
  CompatDiskLruCache(FileSystem fileSystem, File directory, int appVersion, int valueCount, long maxSize,
                     Executor executor) {
  ...
  public synchronized void initialize() throws IOException {
    ...
    if (fileSystem.exists(journalFile)) {
      try {
        ...
        Platform.get().log("DiskLruCache " + directory + " is corrupt: "
   ...
   */
  public static CompatDiskLruCache create(FileSystem fileSystem, File directory, int appVersion,
    ...
    return new CompatDiskLruCache(fileSystem, directory, appVersion, valueCount, maxSize, executor);
  }
  ...
  private BufferedSink newJournalWriter() throws FileNotFoundException {
    ...
    Sink faultHidingSink = new CompatFaultHidingSink(fileSink) {
      @Override protected void onException(IOException e) {
        assert (Thread.holdsLock(CompatDiskLruCache.this));
  ...
  public synchronized Iterator<Snapshot> snapshots() throws IOException {
    ...
    return new Iterator<Snapshot>() {
      ...
      @Override public void remove() {
        ...
        try {
          CompatDiskLruCache.this.remove(removeSnapshot.key);
        } catch (IOException ignored) {
  ...
  public final class Snapshot implements Closeable {
    ...
    Editor edit() throws IOException {
      return CompatDiskLruCache.this.edit(key, sequenceNumber);
    }
  ...
  public final class Editor {
    ...
    public Sink newSink(int index) {
      synchronized (CompatDiskLruCache.this) {
        ...
        return new CompatFaultHidingSink(sink) {
          @Override protected void onException(IOException e) {
            synchronized (CompatDiskLruCache.this) {
              detach();
            }
  ...
  private final class Entry {
     ...
     */
    Snapshot snapshot() {
      if (!Thread.holdsLock(CompatDiskLruCache.this)) throw new AssertionError();
